    ...
    <Card className="h-full min-h-[300px] sm:min-h-[400px] shadow-none flex flex-col">
      ...
      <CardContent className="flex flex-col gap-3 sm:gap-4 flex-1">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 sm:gap-4">
          ...
          >
            <svg className="w-4 h-4" viewBox="0 0 438.549 438.549">
              <path
                fill="currentColor"
          ...
          <Button
            ...
            className="flex items-center gap-2 h-10 sm:h-auto"
          >
            <svg className="w-4 h-4" role="img" viewBox="0 0 24 24">
              <path
                fill="currentColor"
        ...
        <div className="flex flex-col gap-2 sm:gap-3">
          <Label htmlFor="email-create-account" className="text-sm">
            Email
          </Label>
          <Input
        ...
        <div className="flex flex-col gap-2 sm:gap-3">
          <Label htmlFor="password-create-account" className="text-sm">
            Password
          </Label>
          <Input
      ...
      <CardFooter className="pt-3 sm:pt-4">
        <Button className="w-full h-9 sm:h-10">Create account</Button>
      </CardFooter>
    </Card>
  );
}
