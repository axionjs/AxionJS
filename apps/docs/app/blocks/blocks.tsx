    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add login-form-1",
      },
      {
        name: "login-form-2",
        ...
        installCommand: "npx axionjs add login-form-2",
      },
      {
        name: "login-form-3",
        ...
        installCommand: "npx axionjs add login-form-3",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add signup-form-1",
      },
      {
        name: "signup-form-2",
        ...
        installCommand: "npx axionjs add signup-form-2",
      },
      {
        name: "signup-form-3",
        ...
        installCommand: "npx axionjs add signup-form-3",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add newsletter-form-1",
      },
      {
        ...
        installCommand: "npx axionjs add newsletter-form-2",
      },
      {
        ...
        installCommand: "npx axionjs add newsletter-form-3",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add questionnaire-form-1",
      },
      {
        ...
        installCommand: "npx axionjs add questionnaire-form-2",
      },
      {
        ...
        installCommand: "npx axionjs add questionnaire-form-3",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add reset-password-form-1",
      },
      {
        ...
        installCommand: "npx axionjs add reset-password-form-2",
      },
      {
        ...
        installCommand: "npx axionjs add reset-password-form-3",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add event-registration-form-1",
      },
      {
        ...
        installCommand: "npx axionjs add event-registration-form-2",
      },
      {
        ...
        installCommand: "npx axionjs add event-registration-form-3",
      },
    ],
  },
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add hero-app",
      },
      {
        name: "hero-centered",
        ...
        installCommand: "npx axionjs add hero-centered",
      },
      {
        name: "hero-gradient",
      ...
      },
      {
        ...
        installCommand: "npx axionjs add hero-simple",
      },
      {
        name: "hero-split",
        component: HeroSplit,
        ...
        installCommand: "npx axionjs add hero-split",
      },
      {
        name: "hero-video",
        component: HeroVideo,
        ...
        installCommand: "npx axionjs add hero-video",
      },
    ],
  },
  {
    ...
    components: [
      ...
      },
      {
        ...
        installCommand: "npx axionjs add navbar-desktop",
      },
      {
        ...
        installCommand: "npx axionjs add navbar-dropdown",
      },
      {
        name: "navbar-mobile",
        ...
        installCommand: "npx axionjs add navbar-mobile",
      },
      {
        ...
        installCommand: "npx axionjs add navbar-responsive",
      },
      {
        name: "navbar-simple",
        ...
        installCommand: "npx axionjs add navbar-simple",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add faq-accordion",
      },
      {
        name: "faq-grid",
        component: FaqGrid,
        ...
        installCommand: "npx axionjs add faq-grid",
      },
      {
        name: "faq-tabs",
        component: FaqTabs,
        ...
        installCommand: "npx axionjs add faq-tabs",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add footer-dark",
      },
      {
        ...
        installCommand: "npx axionjs add footer-multi-column",
      },
      {
        name: "footer-simple",
        ...
        installCommand: "npx axionjs add footer-simple",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add logo-cloud-featured",
      },
      {
        ...
        installCommand: "npx axionjs add logo-cloud-grid",
      },
      {
        ...
        installCommand: "npx axionjs add logo-cloud-infinite",
      },
      {
        ...
        installCommand: "npx axionjs add logo-cloud-simple",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add pricing-comparison",
      },
      {
        name: "pricing-simple",
        ...
        installCommand: "npx axionjs add pricing-simple",
      },
      {
        name: "pricing-toggle",
        ...
        installCommand: "npx axionjs add pricing-toggle",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add table-basic",
      },
      {
        name: "table-complex",
        ...
        installCommand: "npx axionjs add table-complex",
      },
      {
        ...
        installCommand: "npx axionjs add table-interactive",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add stats-cards",
      },
      {
        name: "stats-feature",
        ...
        installCommand: "npx axionjs add stats-feature",
      },
      {
        name: "stats-grid",
        component: StatsGrid,
        ...
        installCommand: "npx axionjs add stats-grid",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add cta-card",
      },
      {
        name: "cta-centered",
        ...
        installCommand: "npx axionjs add cta-centered",
      },
    ],
  },
  {
    ...
    components: [
      {
        ...
        installCommand: "npx axionjs add testimonials-carousel",
      },
      {
        ...
        installCommand: "npx axionjs add testimonials-featured",
      },
      {
        ...
        installCommand: "npx axionjs add testimonials-grid",
      },
    ],
  },
];
    ...
    <>
      ...
      <div className="container mx-auto py-10 mt-24 mb-12">
        <div className="mb-10 flex items-center justify-between">
          <div>
            <h1 className="text-3xl sm:text-4xl font-bold">UI Blocks</h1>
            <p className="mt-2 text-lg text-muted-foreground">
              A collection of beautiful form components
            </p>
          </div>
        </div>
