...
import VerificationEmail from "@/registry/default/dynamic-components/simple-auth/emails/verification-email";
import ResetPasswordEmail from "@/registry/default/dynamic-components/simple-auth/emails/reset-password-email";
