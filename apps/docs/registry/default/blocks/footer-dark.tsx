    ...
    <footer className="bg-zinc-950 text-zinc-200">
      <div className="mx-auto max-w-7xl px-6 py-12 md:py-16 lg:px-8 lg:py-20">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          <div className="space-y-8">
            ...
            <p className="max-w-xs text-sm text-zinc-400">
              Building better websites, one component at a time. Modern,
        ...
        <div className="mt-12 border-t border-zinc-800 pt-8">
          <div className="flex flex-col items-start justify-between gap-y-8 sm:flex-row sm:items-center">
            ...
            <div className="flex w-full max-w-md flex-col gap-3 sm:flex-row">
              ...
              <Button
                type="submit"
                variant="default"
                className="w-full sm:w-auto bg-white text-zinc-950 hover:bg-zinc-200"
              >
                Subscribe
          ...
          <p className="mt-8 text-xs text-zinc-400">
            &copy; {new Date().getFullYear()} Axion.js. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
