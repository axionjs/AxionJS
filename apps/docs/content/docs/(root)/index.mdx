...
PS D:\PracticeShadCN\Practice\practice_shadcn> npx axionjs add button
✓ Checking registry.
✓ Updating CSS variables in src\app\globals.css
✓ Installing dependencies.
✓ Created 1 file:
...
- **2FA Authentication** - TOTP and SMS verification
- **Session Management** - Secure token handling

### Data Management
- **CRUD Tables** - Create, read, update, delete operations
- **Media Manager** - File upload, resize, optimization
...
```bash
npx axionjs add auth
```
```bash
npx axionjs add crud-table
```
