...
<Callout type="info">
**Quick Start**: Get started with our accessibility toolkit by running `npx axionjs add accessibility`. For comprehensive guides, visit [/docs/accessibility/AccessibilityToolkit](/docs/accessibility/AccessibilityToolkit).
</Callout>
