...
import { splitClassName } from "./transform-css-vars.js";

export const transformTwPrefixes = async ({ sourceFile, config }) => {
...
export function applyPrefix(input, prefix = "") {
...
export function applyPrefixesCss(css, prefix) {
